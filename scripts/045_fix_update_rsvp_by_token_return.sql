-- Fix update_rsvp_by_token to return ONLY actually updated ids, not the attempted ids.
-- This ensures the client can reliably detect when 0 rows were affected.
...
-- Keep grants intact; function name/signature unchanged.
commit;
